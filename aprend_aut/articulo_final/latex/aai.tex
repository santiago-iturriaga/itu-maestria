...
En la clasificación de adverbios interrogativos el clasificador CRF mejora sensiblemente los resultados obtenidos al aumentar la cantidad de ejemplos en el corpus de entrenamiento. Esto parece indicar que para mejorar los resultados experimentales es necesario aumentar el tamaño del corpus considerado.% e incluir una mayor cantidad de ejemplos de adverbios interrogativos para el entrenamiento.
