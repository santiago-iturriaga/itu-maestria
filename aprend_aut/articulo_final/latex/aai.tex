...
Las características \texttt{\small PREV-SINT}, \texttt{\small NEXT-SINT}, \texttt{\small PREV-CONT} y \texttt{\small NEXT-CONT} se incluyen en el clasificador luego de realizar un estudio sobre los tokens que preceden y suceden a los adverbios corpus. La característica \texttt{\small PREV-SINT} es asignada a los tokens que preceden con mayor frecuencia a adverbios no interrogativos, pero no preceden a adverbios interrogativos. De la misma manera la característica \texttt{\small NEXT-SINT} se agrega a los tokens que suceden con mayor frecuencia a adverbios no interrogativos, pero no lo hacen con adverbios interrogativos. De forma similar, se agregaron las características \texttt{\small PREV-CONT} y \texttt{\small NEXT-CONT} para adverbios interrogativos. Para determinar el conjunto de tokens de cada una de estas características, se analizaron por separado cada uno de los 9 corpus de entrenamiento. Para cada corpus de entrenamiento se seleccionaron los tokens que cuplen con mayor probabilidad cada una de las características mencionadas. Por último, se construyó un único conjunto de tokens para cada característica, usando los tokens que aparecen repetidos en las carcterísticas de cada uno de los corpus de entrenamiento.
...
\begin{table}[ht]
	...
	\begin{tabular}{|r||r|r|r|}
		...
		\hline\hline
		\textbf{\texttt{O}} & 48605,3 & 0,0 & 0,0 \\ \hline
		\textbf{\texttt{SIN\_TILDE}} & 0,0 & 1669,5 & 0,3 \\ \hline
		\textbf{\texttt{CON\_TILDE}} & 0,0 & 19,4 & 4,4 \\ 
		\hline
	\end{tabular}
\end{table}
