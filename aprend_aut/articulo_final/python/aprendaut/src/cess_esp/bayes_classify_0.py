...
def palabra_sin_tilde(palabra):
    if palabra == 'cu\xe1ndo':
        return 'cuando'
    elif palabra == 'cu\xe1nto':
        return 'cuanto'
    elif palabra == 'd\xf3nde':
        return 'donde'
    elif palabra == 'c\xf3mo':
        return 'como'
    elif palabra == 'ad\xf3nde':
        return 'adonde'
    elif palabra == 'qu\xe9':
        return 'que'
...
def build_set(oraciones):
    ...
    for oracion in oraciones:
        for palabra_index in range(len(oracion)):
            ...
            if palabra_norm == 'cu\xe1ndo' or palabra_norm == 'cu\xe1nto' \
            or palabra_norm == 'd\xf3nde' or palabra_norm == 'c\xf3mo' \
            or palabra_norm == 'ad\xf3nde' or palabra_norm == 'qu\xe9' \
            or palabra_norm == 'cuando' or palabra_norm == 'cuanto' \
            or palabra_norm == 'donde' or palabra_norm == 'como' \
            or palabra_norm == 'adonde' or palabra_norm == 'que':
