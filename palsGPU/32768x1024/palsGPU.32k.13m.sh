...
do
    ...
    echo "time (${BASE_PATH}/bin/pals ${INSTANCE}${i}.dat ${DIMENSION} 2 ${RAND} 0 120 1> ${BASE_PATH}/32768x1024/solutions/${i}.pals.sol) 2> ${BASE_PATH}/32768x1024/solutions/${i}.pals.time"

    time (${BASE_PATH}/bin/pals ${INSTANCE}${i}.dat ${DIMENSION} 2 ${RAND} 0 710 \
