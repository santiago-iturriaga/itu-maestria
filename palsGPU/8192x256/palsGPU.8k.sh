...
do
    ...
    echo "time (${BASE_PATH}/bin/pals ${INSTANCE}${i}.dat ${DIMENSION} 2 ${RAND} 0 5 1> ${BASE_PATH}/8192x256/solutions/${i}.pals.sol) 2> ${BASE_PATH}/8192x256/solutions/${i}.pals.time"

    time (${BASE_PATH}/bin/pals ${INSTANCE}${i}.dat ${DIMENSION} 2 ${RAND} 0 5 \
