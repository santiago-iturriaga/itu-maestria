...
#ifndef __EnergyEfficientAdaptive_application_h__
#define __EnergyEfficientAdaptive_application_h__
 ...
 * \defgroup EnergyEfficientAdaptiveApplication
 *
 * Creates a EnergyEfficientAdaptive tree topology
 * Author: Patricia Ruiz
**/

class EnergyEfficientAdaptiveApplication : public Application 
...
public:
  ...
  EnergyEfficientAdaptiveApplication ();
  virtual ~EnergyEfficientAdaptiveApplication();
...
private:
	...
	TypeId          m_tid;
	double          m_pwRxDbm;
    Ptr<Socket>     m_EnergyEfficientAdaptiveSocket; // Associated socket
	Ipv4Address     m_addr; 	
