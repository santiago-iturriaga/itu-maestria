...
public:
  ...
  void MySetForwardUpCallback (Callback<void,Ptr<Packet>, Mac48Address, double> neighborCallback);	
  void MySetForwardUpNeighborLostCallback (Callback<void,Ptr<Packet>, Mac48Address> neighborLostCallback);	
