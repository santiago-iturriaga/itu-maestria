...
#ifndef __DB_application_h__
#define __DB_application_h__
 ...
 * \defgroup DBApplication
 *
 * Author: Patricia Ruiz
**/

class DBApplication : public Application 
...
private:
	...
	TypeId          m_tid;
	double          m_pwRxDbm;
    Ptr<Socket>     m_DBSocket; // Associated socket
	Ipv4Address     m_addr; 	
