...
SOLUTIONS_BASE_PATH="../../512x16.24.adhoc"
FP_BASE_PATH="../../512x16.fp"
...
do
    ...
    do
        ...
        do       
            ...
            OUT="${METRICS_PATH}/${ALGORITHM}.scenario.${SCENARIOS[s]}.workload.${WORKLOADS[w]}.${i}.hv"
            
            java -classpath $CLASSPATH jmetal.qualityIndicator.Hypervolume ${IN} ${FP} $NUM_OBJ > ${OUT}
        done
    done
done
