...
do
    ...
    do
        ...
        #do       
            OUT="${METRICS_PATH}/fp.scenario.${SCENARIOS[s]}.workload.${WORKLOADS[w]}.hv"
            
            java -classpath $CLASSPATH jmetal.qualityIndicator.Hypervolume ${FP} ${FP} $NUM_OBJ > ${OUT}
        #done
    done
done
