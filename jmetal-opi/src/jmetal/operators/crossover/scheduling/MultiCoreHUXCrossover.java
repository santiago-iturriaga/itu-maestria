		...
		try {
			if (PseudoRandom.randDouble() < probability) {
				for (int var = 0; var < parent1.getDecisionVariables().length; var++) {
					MultiCoreMachine p1 = (MultiCoreMachine) parent1.getDecisionVariables()[var];
					MultiCoreMachine p2 = (MultiCoreMachine) parent2.getDecisionVariables()[var];
			...
			Configuration.logger_.severe("HUXCrossover.doCrossover: Cannot perfom MultiCoreHUXCrossover");
			Class cls = java.lang.String.class;
			String name = cls.getName();
