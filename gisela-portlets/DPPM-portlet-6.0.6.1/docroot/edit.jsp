...
<jsp:useBean id="pref_job" class="java.lang.String" scope="request"/>
...
<td>
<p><h4>octave_portlet preferences</h4>
...
<ul>
  ...
  <li><b>For each infrastructure:</b>
      ...
      <li><b>Job requirements</b> - This is a ';' separated list of job requirements</li>
      <p> Please use the <b>&lt;</b>/<b>&gt;</b> buttons to change infrastructure and <b>+</b>/<b>-</b> buttons to add or remove infrastructure settings.
      </ul>     
  <li><b>Pilot script</b> - This script controls the job execution into the infrastructure</li>
  <li><b>UserProxy</b> - A complete path to an user proxy (When specified it overrides the use of robot proxy</li>
</ul>
...
<tr>
  <td align="right" ><b>Application Identifier</b> </td>
...
<td align="right" style="color: blue; background-color:#d0d0d0;"><b>Job Requirements </b></td>
...
<tr>
  <td align="right" >Use the Local Proxy </td>
