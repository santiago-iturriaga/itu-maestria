...
//
public class DPPM_portlet extends GenericPortlet {
    ...
    AppLogger _log = new AppLogger(DPPM_portlet.class);
    ...
    class App_Input {
        ...
        String thetaParam;   	// Text for application input file 
    ...
    private enum inputControlsIds {
       ...
       ,thetaParam         // Input file input file
    ...
    if (PortletFileUpload.isMultipartContent(request))
        try {                
            ...
            while (iter.hasNext()) {
                ...
                switch(inputControlsIds.valueOf(fieldName)) {
                    ...
                    break;
                    case thetaParam:
                        appInput.thetaParam=item.getString();
                    break;
                    case JobIdentifier:
        ...
        // The input form do not use the "multipart/form-data" 
            ...
            appInput.thetaParam=(String)request.getParameter("thetaParam");
        ...
        _log.info(
              ...
              +LS+"inputFileText: '"+appInput.thetaParam+"'"
    ...
    void updateFiles(App_Input appInput) {
        ...
        try {            
            ...
            bwInput.write(appInput.thetaParam);
            bwInput.close();
        }
        catch (Exception e) {
    ...
    void submitJob(App_Input appInput) {         
        ...
        if(numInfras >0) {
            ...
            String arguments =appPreferences.pilotScript+" "+appInput.thetaParam; // executable' arguments 
            String outputPath="/tmp/";                    // Output Path
            String outputFile="DPPM-Output.txt";      // Distributed application standard output
            String errorFile ="DPPM-Error.txt";       // Distrubuted application standard error
            String appFile   ="DPPM-Files.tar.gz";    // Hostname output files (created by the pilot script)
            ...
            String inputSandbox= appServerPath+"WEB-INF/job/"+appPreferences.pilotScript // pilot script
                               ...
                               +","+appServerPath+"WEB-INF/job/DeadLineProblem_seq"
			       +","+appServerPath+"WEB-INF/job/Calibracion.txt"
                               ;  
