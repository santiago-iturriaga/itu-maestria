...
void ls_best_swap_complex_selection(pals_cpu_1pop_thread_arg *thread_instance, solution *selected_solution,
...
void ls_best_move_complex_selection(pals_cpu_1pop_thread_arg *thread_instance, solution *selected_solution,
