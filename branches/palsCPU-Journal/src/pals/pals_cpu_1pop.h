...
#define PALS_CPU_1POP_WORK__THREAD_ITERATIONS       5
...
#define PALS_CPU_1POP_SEARCH__ENERGY_GREEDY_PSEL_BEST       0.30
#define PALS_CPU_1POP_SEARCH__ENERGY_GREEDY_PSEL_WORST      0.00

#define PALS_CPU_1POP_SEARCH_BALANCE__MAKESPAN  0.45
