...
#define PALS_CPU_1POP_WORK__THREAD_ITERATIONS       16
...
#define PALS_CPU_1POP_WORK__DST_MACH_NHOOD      12
...
#define PALS_CPU_1POP_SEARCH__MAKESPAN_GREEDY_PSEL_BEST     0.85
#define PALS_CPU_1POP_SEARCH__MAKESPAN_GREEDY_PSEL_WORST    0.25
