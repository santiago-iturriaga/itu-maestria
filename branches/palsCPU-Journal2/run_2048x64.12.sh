    ...
    do
        ...
        do
            ...
            do       
                ...
                echo "plot '${OUT}.metrics' using 1:2 title 'PALS', '${MINMIN_METRICS_PATH}.scenario.${SCENARIOS[s]}.workload.${WORKLOADS[w]}.metrics' using 1:2 title 'MinMin'" >> ${OUT}.plot
                ...
                echo "plot '${OUT}.metrics' using 1:2 title 'PALS'" >> ${OUT}.2.plot
            ...
            echo "plot '${TODAS_LAS_SOLUCIONES}.fp' using 1:2 title 'PALS', '${MINMIN_METRICS_PATH}.scenario.${SCENARIOS[s]}.workload.${WORKLOADS[w]}.metrics' using 1:2 title 'MinMin'" >> ${TODAS_LAS_SOLUCIONES}.plot
