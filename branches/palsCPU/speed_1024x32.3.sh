...
SOLUTIONS_BASE_DIR="1024x32.3.speed"
THREADS=3
ITERATIONS=15
    ...
    do
        ...
        do
            ...
            do       
                ...
                RAND=$RANDOM
                EXEC="${ALGORITHMS[a]} ${INSTANCES_PATH}/scenario.${SCENARIOS[s]} ${INSTANCES_PATH}/workload.${WORKLOADS[w]} ${DIMENSIONS} ${ALGORITHMS_ID[a]} ${THREADS} ${RAND} ${PALS_TIMEOUT} ${PALS_ITERATIONS} ${POPULATION_SIZE} ${POPULATION_SIZE}"
                echo ${EXEC}
