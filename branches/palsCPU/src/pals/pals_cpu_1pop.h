...
#define PALS_CPU_1POP_WORK__POP_SIZE_FACTOR    5
...
#define PALS_CPU_1POP_SEARCH_OP_BALANCE__SWAP 0.8
#define PALS_CPU_1POP_SEARCH_OP_BALANCE__MOVE 0.2
...
#define PALS_CPU_1POP_SEARCH_BALANCE__ENERGY   0.15
