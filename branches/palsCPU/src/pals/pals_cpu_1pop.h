...
#define PALS_CPU_1POP_WORK__THREAD_ITERATIONS       150
...
#define PALS_CPU_1POP_SEARCH__MAKESPAN_GREEDY_PSEL_BEST     0.45
#define PALS_CPU_1POP_SEARCH__MAKESPAN_GREEDY_PSEL_WORST    0.45
