...
#define PALS_CPU_1POP_WORK__THREAD_CONVERGENCE  200
#define PALS_CPU_1POP_WORK__THREAD_ITERATIONS   200

#define PALS_CPU_1POP_WORK__POP_SIZE_FACTOR     10

#define PALS_CPU_1POP_WORK__SRC_TASK_NHOOD      4
#define PALS_CPU_1POP_WORK__DST_TASK_NHOOD      10
#define PALS_CPU_1POP_WORK__DST_MACH_NHOOD      4

#define PALS_CPU_1POP_SEARCH_OP__SWAP           0
#define PALS_CPU_1POP_SEARCH_OP__MOVE           1

#define PALS_CPU_1POP_SEARCH_OP_BALANCE__SWAP   0.70
#define PALS_CPU_1POP_SEARCH_OP_BALANCE__MOVE   0.30
...
#define PALS_CPU_1POP_SEARCH_BALANCE__MAKESPAN  0.50
#define PALS_CPU_1POP_SEARCH_BALANCE__ENERGY    0.30 
