...
inline int ccudaMemcpy(void *dest, void *src, size_t size, enum cudaMemcpyKind kind)
{
...
inline int ccudaEventElapsedTime(float * ms, cudaEvent_t start, cudaEvent_t end)
{
...
inline int ccudaMemcpyToSymbol(const void * symbol, const void * src,
