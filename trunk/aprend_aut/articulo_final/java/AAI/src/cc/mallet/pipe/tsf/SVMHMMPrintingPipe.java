 ...
 *          Exp $
 */
public class SVMHMMPrintingPipe extends Pipe implements Serializable {
	private String logFile;
	private PrintWriter writer;
	private int index;

	public SVMHMMPrintingPipe() {
		super(new Alphabet(), null);
		
		this.index = 0;
	}

	public SVMHMMPrintingPipe(Alphabet dataDict) {
		super(dataDict, null);
		
		this.index = 0;
	}
	
	public SVMHMMPrintingPipe(String logFile) throws FileNotFoundException {
		super(new Alphabet(), null);
