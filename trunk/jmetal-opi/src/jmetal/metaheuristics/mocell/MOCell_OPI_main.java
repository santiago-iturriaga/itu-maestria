 ...
 * F. Luna, B. Dorronsoro, E. Alba
 * "Design Issues in a Multiobjective Cellular Genetic Algorithm." Evolutionary
 * Multi-Criterion Optimization. 4th International Conference, EMO 2007.
 * Sendai/Matsushima, Japan, March 2007.
 */
public class MOCell_OPI_main {
	...
	public static void main(String[] args) throws JMException,
		...
		fileHandler_ = new FileHandler(basePath + "MOCell_main.log");
		...
		if (args.length == 5) {
			...
			problem = MultiCoreSchedulingProblem
					.loadMultiCoreSchedulingProblem(task_arrival_file,
							task_priority_file, task_cores_file,
							task_cost_file, machine_file);
			...
			algorithm.setInputParameter("maxEvaluations", 4000000);
