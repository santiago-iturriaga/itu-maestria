...
#define SORT_MULTI_BEST_KERNEL_BLOCKS       PALS_GPU_RTASK__BLOCKS
#define SORT_MULTI_BEST_KERNEL_THREADS      1

#define APPLY_MULTI_BEST_KERNEL_BLOCKS      1
#define APPLY_MULTI_BEST_KERNEL_THREADS     PALS_GPU_RTASK__BLOCKS
