...
#ifndef __EnergyEfficientOptimized_application_h__
#define __EnergyEfficientOptimized_application_h__
 ...
 * \defgroup EnergyEfficientOptimizedApplication
 *
 * Creates a EnergyEfficientOptimized tree topology
 * Author: Patricia Ruiz
**/

class EnergyEfficientOptimizedApplication : public Application 
...
public:
  ...
  EnergyEfficientOptimizedApplication ();
  virtual ~EnergyEfficientOptimizedApplication();
...
private:
	...
	TypeId          m_tid;
	double          m_pwRxDbm;
    Ptr<Socket>     m_EnergyEfficientOptimizedSocket; // Associated socket
	Ipv4Address     m_addr; 	
