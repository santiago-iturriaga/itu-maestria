...
#ifndef __GreenDBDA_application_h__
#define __GreenDBDA_application_h__
 ...
 * \defgroup GreenDBDAApplication
 *
 * Creates a GreenDBDA tree topology
 * Author: Patricia Ruiz
**/

class GreenDBDAApplication : public Application 
...
public:
  ...
  GreenDBDAApplication ();
  virtual ~GreenDBDAApplication();
...
private:
	...
	TypeId          m_tid;
	double          m_pwRxDbm;
    Ptr<Socket>     m_GreenDBDASocket; // Associated socket
	Ipv4Address     m_addr; 	
