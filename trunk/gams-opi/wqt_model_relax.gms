...
POSITIVE VARIABLE assignment_m(t,m)        'asignacion de la tarea t en la maquina m';
POSITIVE VARIABLE assignment_mc(t,m,c)     'asignacion de la tarea t en la maquina m en el core c';
POSITIVE VARIABLE precedence(t,tt,m,c)     't es previa de tt en la maquina m, core c';
POSITIVE VARIABLE start(t,m,c)             'la tarea es la primera del core c en la maquina m';
